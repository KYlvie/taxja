...
FAMILY_LABELS_BY_LANGUAGE = {
    ...
    "fr": {
        "receipts-invoices": "Recus et factures",
        "bank-statements": "Releves bancaires",
        "tax-forms-and-assessments": "Formulaires fiscaux et avis",
        "payroll-social-insurance": "Salaire et assurance sociale",
        "deductions-and-supporting-proof": "Deductions et justificatifs",
        "property-and-financial-docs": "Documents immobiliers et financiers",
        "foundation-materials": "Documents de base a long terme",
        "other-linked": "Autres documents lies",
    },
    "ru": {
        "receipts-invoices": "Чеки и счета",
        "bank-statements": "Банковские выписки",
        "tax-forms-and-assessments": "Налоговые формы и решения",
        "payroll-social-insurance": "Зарплата и социальное страхование",
        "deductions-and-supporting-proof": "Вычеты и подтверждающие документы",
        "property-and-financial-docs": "Документы по недвижимости и финансам",
        "foundation-materials": "Долгосрочные базовые документы",
        "other-linked": "Прочие связанные документы",
    },
    "hu": {
        "receipts-invoices": "Nyugtak es szamlak",
        "bank-statements": "Bankkivonatok",
        "tax-forms-and-assessments": "Adonyomtatvanyok es hatarozatok",
        "payroll-social-insurance": "Ber es tarsadalombiztositas",
        "deductions-and-supporting-proof": "Levonasok es igazolasok",
        "property-and-financial-docs": "Ingatlan- es penzugyi dokumentumok",
        "foundation-materials": "Hosszu tavu alapdokumentumok",
        "other-linked": "Egyeb kapcsolodo dokumentumok",
    },
    "pl": {
        "receipts-invoices": "Paragony i faktury",
        "bank-statements": "Wyciagi bankowe",
        "tax-forms-and-assessments": "Formularze podatkowe i decyzje",
        "payroll-social-insurance": "Wynagrodzenia i ubezpieczenia spoleczne",
        "deductions-and-supporting-proof": "Odliczenia i dokumenty potwierdzajace",
        "property-and-financial-docs": "Dokumenty nieruchomosci i finansowe",
        "foundation-materials": "Dlugoterminowe dokumenty podstawowe",
        "other-linked": "Inne powiazane dokumenty",
    },
    "tr": {
        "receipts-invoices": "Fisler ve faturalar",
        "bank-statements": "Banka ekstreleri",
        "tax-forms-and-assessments": "Vergi formlari ve kararlar",
        "payroll-social-insurance": "Maas ve sosyal sigorta",
        "deductions-and-supporting-proof": "Kesintiler ve destekleyici belgeler",
        "property-and-financial-docs": "Mulk ve finansal belgeler",
        "foundation-materials": "Uzun vadeli temel belgeler",
        "other-linked": "Diger bagli belgeler",
    },
    "bs": {
        "receipts-invoices": "Racuni i fakture",
        "bank-statements": "Bankovni izvodi",
        "tax-forms-and-assessments": "Porezni obrasci i rjesenja",
        "payroll-social-insurance": "Plata i socijalno osiguranje",
        "deductions-and-supporting-proof": "Odbici i popratni dokazi",
        "property-and-financial-docs": "Dokumenti o nekretninama i financijama",
        "foundation-materials": "Dugorocni osnovni dokumenti",
        "other-linked": "Ostali povezani dokumenti",
    },
}
...
TRANSACTION_EXPORT_LABELS = {
    ...
    "ru": {
        ...
        "linked_docs": "Связанные документы",
        "yes": "Да",
        "no": "Нет",
        "income": "Доход",
        "expense": "Расход",
    ...
    "hu": {
        "title": "Tranzakciok",
        "generated": "Letrehozva",
        "date": "Datum",
        "type": "Tipus",
        "amount": "Osszeg",
        "description": "Leiras",
        "category": "Kategoria",
        "deductible": "Levonhato",
        "linked_docs": "Kapcsolt dokumentumok",
        "yes": "Igen",
        "no": "Nem",
        "income": "Bevetel",
        "expense": "Kiadas",
    ...
    "pl": {
        ...
        "linked_docs": "Powiazane dokumenty",
        "yes": "Tak",
        "no": "Nie",
        "income": "Przychod",
        "expense": "Wydatek",
    ...
    "tr": {
        "title": "Islemler",
        "generated": "Olusturulma tarihi",
        "date": "Tarih",
        "type": "Tur",
        "amount": "Tutar",
        "description": "Aciklama",
        "category": "Kategori",
        "deductible": "Indirilebilir",
        "linked_docs": "Bagli belgeler",
        "yes": "Evet",
        "no": "Hayir",
        "income": "Gelir",
        "expense": "Gider",
    ...
    "bs": {
        ...
        "category": "Kategorija",
        "deductible": "Odbitan",
        "linked_docs": "Povezani dokumenti",
        "yes": "Da",
        "no": "Ne",
        "income": "Prihod",
        "expense": "Rashod",
...
SUMMARY_TEXT = {
    ...
    "fr": {
        "title": "Resume du dossier fiscal",
        "tax_year": "Annee fiscale",
        "generated_at": "Genere le",
        "language": "Langue",
        "parts": "Parties",
        "foundation": "Inclut les documents de base",
        "yes": "Oui",
        "no": "Non",
        "included_heading": "Contenu inclus et exclu",
        "included": "Inclus",
        "excluded": "Non inclus",
        "included_list": "PDF de synthese, CSV des transactions, PDF des transactions, documents fiscaux sources",
        "excluded_list": "Les autres PDF de rapports restent disponibles separement sur la page des rapports",
        "year_rule": "Regle d'attribution de l'annee du document",
        "year_rule_text": "D'abord document_date, puis document_year, enfin uploaded_at",
        "other_rule": "Regle pour les documents de type autre",
        "other_rule_text": "Les documents de type autre ne sont inclus que s'ils sont lies a des transactions exportees de l'annee fiscale.",
        "transactions_heading": "Apercu annuel des transactions",
        "tx_count": "Nombre de transactions",
        "income_total": "Total des revenus",
        "expense_total": "Total des depenses",
        "deductible_total": "Total deductible",
        "reconciled_count": "Nombre rapproche",
        "pending_tx_count": "Transactions en attente de verification",
        "ignored_count": "Nombre ignore",
        "documents_heading": "Apercu annuel des documents",
        "included_docs": "Documents inclus",
        "family_counts": "Nombre par famille",
        "excluded_docs": "Documents exclus",
        "risks_heading": "Risques et rappels",
        "pending_docs": "Documents en attente de verification dans ce dossier",
        "uncertain_year_docs": "Documents attribues a cette annee par date de telechargement",
        "skipped_files": "Fichiers exclus de l'export",
        "no_risks": "Aucun risque ouvert n'a ete detecte pour ce dossier.",
        "all_parts_notice": "Conservez toutes les parties ensemble si le dossier a ete divise.",
        "usage_heading": "Comment utiliser ce dossier",
        "usage_text": "Ce dossier contient le PDF de synthese, le CSV des transactions annuelles, le PDF des transactions annuelles et les documents fiscaux sources pour l'annee fiscale selectionnee. Les autres PDF de rapports ne sont pas inclus et doivent etre telecharges separement depuis la page des rapports. L'attribution de l'annee du document utilise d'abord document_date, puis document_year, et enfin uploaded_at. Les documents de type autre ne sont inclus que s'ils sont lies a des transactions exportees de l'annee fiscale selectionnee.",
        "reason_year_mismatch": "Document attribue a une autre annee fiscale",
        "reason_foundation_opt_out": "Documents de base non demandes",
        "reason_other_unlinked": "Document autre non lie a une transaction exportee de cette annee fiscale",
        "reason_storage_missing": "Fichier stocke manquant ou illisible",
        "reason_unsupported": "Type de document non pris en charge pour le dossier fiscal",
        "reason_limit": "Le dossier depasse les limites d'export",
    },
    "ru": {
        "title": "Сводка налогового пакета",
        "tax_year": "Налоговый год",
        "generated_at": "Создано",
        "language": "Язык",
        "parts": "Части",
        "foundation": "Включает базовые документы",
        "yes": "Да",
        "no": "Нет",
        "included_heading": "Включенное и исключенное содержимое",
        "included": "Включено",
        "excluded": "Не включено",
        "included_list": "Сводка PDF, транзакции CSV, транзакции PDF, налоговые исходные документы",
        "excluded_list": "Другие PDF-отчеты доступны отдельно на странице отчетов",
        "year_rule": "Правило определения года документа",
        "year_rule_text": "Сначала document_date, затем document_year, затем uploaded_at",
        "other_rule": "Правило для прочих документов",
        "other_rule_text": "Документы типа Прочие включаются только при наличии связи с экспортированными транзакциями года.",
        "transactions_heading": "Годовой обзор транзакций",
        "tx_count": "Количество транзакций",
        "income_total": "Итого доходы",
        "expense_total": "Итого расходы",
        "deductible_total": "Итого вычитаемые",
        "reconciled_count": "Сверено",
        "pending_tx_count": "Транзакции на проверке",
        "ignored_count": "Игнорировано",
        "documents_heading": "Годовой обзор документов",
        "included_docs": "Включенные документы",
        "family_counts": "Количество по семействам",
        "excluded_docs": "Исключенные документы",
        "risks_heading": "Риски и напоминания",
        "pending_docs": "Документы на проверке в данном пакете",
        "uncertain_year_docs": "Документы, отнесенные к этому году по дате загрузки",
        "skipped_files": "Файлы, исключенные из экспорта",
        "no_risks": "Открытых рисков для данного пакета не обнаружено.",
        "all_parts_notice": "Сохраняйте все части вместе, если пакет был разделен.",
        "usage_heading": "Как использовать этот пакет",
        "usage_text": "Этот пакет содержит сводку PDF, годовой CSV транзакций, годовой PDF транзакций и налоговые исходные документы за выбранный налоговый год. Другие PDF-отчеты не включены и должны быть загружены отдельно со страницы отчетов. Год документа определяется по document_date, затем document_year, затем uploaded_at. Документы типа Прочие включаются только при связи с экспортированными транзакциями выбранного налогового года.",
        "reason_year_mismatch": "Документ отнесен к другому налоговому году",
        "reason_foundation_opt_out": "Базовые материалы не запрашивались",
        "reason_other_unlinked": "Прочий документ не связан с экспортированной транзакцией этого налогового года",
        "reason_storage_missing": "Сохраненный файл отсутствует или нечитаем",
        "reason_unsupported": "Неподдерживаемый тип документа для налогового пакета",
        "reason_limit": "Пакет превышает лимиты экспорта",
    },
    "hu": {
        "title": "Adocsomag osszefoglalo",
        "tax_year": "Adoev",
        "generated_at": "Letrehozva",
        "language": "Nyelv",
        "parts": "Reszek",
        "foundation": "Tartalmazza az alapdokumentumokat",
        "yes": "Igen",
        "no": "Nem",
        "included_heading": "Tartalmazott es kizart tartalom",
        "included": "Tartalmazott",
        "excluded": "Nem tartalmazott",
        "included_list": "Osszefoglalo PDF, tranzakciok CSV, tranzakciok PDF, adougyi forrasdokumentumok",
        "excluded_list": "Mas jelentes-PDF-ek kulon erhetok el a jelentesek oldalon",
        "year_rule": "Dokumentum ev-szabaly",
        "year_rule_text": "Eloszor document_date, aztan document_year, vegul uploaded_at",
        "other_rule": "Egyeb dokumentumok szabalya",
        "other_rule_text": "Az egyeb tipusu dokumentumok csak akkor kerulnek be, ha az adoev exportalt tranzakcioihoz kapcsolodnak.",
        "transactions_heading": "Eves tranzakcio attekintes",
        "tx_count": "Tranzakciok szama",
        "income_total": "Bevetel osszesen",
        "expense_total": "Kiadas osszesen",
        "deductible_total": "Levonhato osszesen",
        "reconciled_count": "Egyeztetett szam",
        "pending_tx_count": "Ellenorzesre varo tranzakciok",
        "ignored_count": "Figyelmen kivul hagyott szam",
        "documents_heading": "Eves dokumentum attekintes",
        "included_docs": "Tartalmazott dokumentumok",
        "family_counts": "Szam csalad szerint",
        "excluded_docs": "Kizart dokumentumok",
        "risks_heading": "Kockazatok es emlekeztetok",
        "pending_docs": "Ellenorzesre varo dokumentumok ebben a csomagban",
        "uncertain_year_docs": "Feltoltesi datum alapjan ehhez az evhez rendelt dokumentumok",
        "skipped_files": "Exportbol kizart fajlok",
        "no_risks": "Nem eszleltunk nyitott kockazatot ehhez a csomaghoz.",
        "all_parts_notice": "Tartsa egyutt az osszes reszt, ha a csomag felosztasra kerult.",
        "usage_heading": "A csomag hasznalata",
        "usage_text": "Ez a csomag tartalmazza az osszefoglalo PDF-et, az eves tranzakcio CSV-t, az eves tranzakcio PDF-et es az adougyi forrasdokumentumokat a kivalasztott adoevre. Mas jelentes-PDF-ek nincsenek benne, es kulon tolthetok le a jelentesek oldalrol. A dokumentum ev meghataroza: eloszor document_date, aztan document_year, vegul uploaded_at. Az egyeb tipusu dokumentumok csak akkor kerulnek be, ha a kivalasztott adoev exportalt tranzakcioihoz kapcsolodnak.",
        "reason_year_mismatch": "A dokumentum masik adoevhez van rendelve",
        "reason_foundation_opt_out": "Alapanyagok nem kertek",
        "reason_other_unlinked": "Egyeb dokumentum nem kapcsolodik az adoev exportalt tranzakciojahoz",
        "reason_storage_missing": "A tarolt fajl hianyzik vagy olvashatatlan",
        "reason_unsupported": "Nem tamogatott dokumentumtipus az adocsomaghoz",
        "reason_limit": "A csomag meghaladja az export-korlatokat",
    },
    "pl": {
        "title": "Podsumowanie pakietu podatkowego",
        "tax_year": "Rok podatkowy",
        "generated_at": "Wygenerowano",
        "language": "Jezyk",
        "parts": "Czesci",
        "foundation": "Zawiera dokumenty podstawowe",
        "yes": "Tak",
        "no": "Nie",
        "included_heading": "Zawartosc uwzgledniona i wykluczona",
        "included": "Uwzglednione",
        "excluded": "Nieuwzglednione",
        "included_list": "PDF podsumowania, CSV transakcji, PDF transakcji, zrodlowe dokumenty podatkowe",
        "excluded_list": "Inne raporty PDF sa dostepne osobno na stronie raportow",
        "year_rule": "Regula roku dokumentu",
        "year_rule_text": "Najpierw document_date, potem document_year, na koniec uploaded_at",
        "other_rule": "Regula dla dokumentow typu inne",
        "other_rule_text": "Dokumenty typu inne sa uwzgledniane tylko jesli sa powiazane z eksportowanymi transakcjami danego roku podatkowego.",
        "transactions_heading": "Roczny przeglad transakcji",
        "tx_count": "Liczba transakcji",
        "income_total": "Suma przychodow",
        "expense_total": "Suma wydatkow",
        "deductible_total": "Suma odliczen",
        "reconciled_count": "Liczba uzgodnionych",
        "pending_tx_count": "Transakcje oczekujace na weryfikacje",
        "ignored_count": "Liczba zignorowanych",
        "documents_heading": "Roczny przeglad dokumentow",
        "included_docs": "Uwzglednione dokumenty",
        "family_counts": "Liczba wg rodziny",
        "excluded_docs": "Wykluczone dokumenty",
        "risks_heading": "Ryzyka i przypomnienia",
        "pending_docs": "Dokumenty oczekujace na weryfikacje w tym pakiecie",
        "uncertain_year_docs": "Dokumenty przypisane do tego roku na podstawie daty przeslania",
        "skipped_files": "Pliki wykluczone z eksportu",
        "no_risks": "Nie wykryto otwartych ryzyk dla tego pakietu.",
        "all_parts_notice": "Zachowaj wszystkie czesci razem, jesli pakiet zostal podzielony.",
        "usage_heading": "Jak korzystac z tego pakietu",
        "usage_text": "Ten pakiet zawiera PDF podsumowania, roczny CSV transakcji, roczny PDF transakcji oraz zrodlowe dokumenty podatkowe za wybrany rok podatkowy. Inne raporty PDF nie sa uwzglednione i powinny byc pobierane osobno ze strony raportow. Rok dokumentu jest okreslany wedlug: document_date, nastepnie document_year, na koniec uploaded_at. Dokumenty typu inne sa uwzgledniane tylko jesli sa powiazane z eksportowanymi transakcjami wybranego roku podatkowego.",
        "reason_year_mismatch": "Dokument przypisany do innego roku podatkowego",
        "reason_foundation_opt_out": "Materialy podstawowe nie zostaly zażadane",
        "reason_other_unlinked": "Inny dokument niepowiazany z eksportowana transakcja tego roku podatkowego",
        "reason_storage_missing": "Zapisany plik brakujacy lub nieczytelny",
        "reason_unsupported": "Nieobslugiwany typ dokumentu dla pakietu podatkowego",
        "reason_limit": "Pakiet przekracza limity eksportu",
    },
    "tr": {
        "title": "Vergi paketi ozeti",
        "tax_year": "Vergi yili",
        "generated_at": "Olusturulma tarihi",
        "language": "Dil",
        "parts": "Parcalar",
        "foundation": "Temel belgeleri icerir",
        "yes": "Evet",
        "no": "Hayir",
        "included_heading": "Dahil edilen ve haric tutulan icerik",
        "included": "Dahil",
        "excluded": "Dahil degil",
        "included_list": "Ozet PDF, islem CSV, islem PDF, vergiye iliskin kaynak belgeler",
        "excluded_list": "Diger rapor PDF'leri raporlar sayfasindan ayri olarak indirilebilir",
        "year_rule": "Belge yili kurali",
        "year_rule_text": "Once document_date, sonra document_year, en son uploaded_at",
        "other_rule": "Diger belge turlerinin kurali",
        "other_rule_text": "Diger tur belgeler yalnizca vergi yili icin disa aktarilan islemlerle baglantili olduklarinda dahil edilir.",
        "transactions_heading": "Yillik islem genel gorunumu",
        "tx_count": "Islem sayisi",
        "income_total": "Gelir toplami",
        "expense_total": "Gider toplami",
        "deductible_total": "Indirilebilir toplam",
        "reconciled_count": "Mutabik sayisi",
        "pending_tx_count": "Dogrulama bekleyen islemler",
        "ignored_count": "Yok sayilan sayi",
        "documents_heading": "Yillik belge genel gorunumu",
        "included_docs": "Dahil edilen belgeler",
        "family_counts": "Aileye gore sayilar",
        "excluded_docs": "Haric tutulan belgeler",
        "risks_heading": "Riskler ve hatirlaticilar",
        "pending_docs": "Bu pakette dogrulama bekleyen belgeler",
        "uncertain_year_docs": "Yukleme tarihine gore bu yila atanan belgeler",
        "skipped_files": "Disari aktarimdan haric tutulan dosyalar",
        "no_risks": "Bu paket icin acik risk tespit edilmedi.",
        "all_parts_notice": "Paket bolunmusse tum parcalari bir arada tutun.",
        "usage_heading": "Bu paketin kullanimi",
        "usage_text": "Bu paket, secilen vergi yili icin ozet PDF, yillik islem CSV, yillik islem PDF ve vergiye iliskin kaynak belgeleri icerir. Diger rapor PDF'leri dahil degildir ve raporlar sayfasindan ayri olarak indirilmelidir. Belge yili sirasiya: document_date, document_year, uploaded_at. Diger tur belgeler yalnizca secilen vergi yilinin disa aktarilan islemleriyle baglantili olduklarinda dahil edilir.",
        "reason_year_mismatch": "Belge farkli bir vergi yilina atanmis",
        "reason_foundation_opt_out": "Temel materyaller istenmedi",
        "reason_other_unlinked": "Diger belge bu vergi yilinin disa aktarilan islemine bagli degil",
        "reason_storage_missing": "Depolanan dosya eksik veya okunamiyor",
        "reason_unsupported": "Vergi paketi icin desteklenmeyen belge turu",
        "reason_limit": "Paket disa aktarim sinirlarini asiyor",
    },
    "bs": {
        "title": "Sazetak poreznog paketa",
        "tax_year": "Porezna godina",
        "generated_at": "Kreirano",
        "language": "Jezik",
        "parts": "Dijelovi",
        "foundation": "Ukljucuje osnovne dokumente",
        "yes": "Da",
        "no": "Ne",
        "included_heading": "Ukljuceni i iskljuceni sadrzaj",
        "included": "Ukljuceno",
        "excluded": "Nije ukljuceno",
        "included_list": "Sazetak PDF, transakcije CSV, transakcije PDF, porezni izvorni dokumenti",
        "excluded_list": "Ostali izvjestajni PDF-ovi dostupni su zasebno na stranici izvjestaja",
        "year_rule": "Pravilo za godinu dokumenta",
        "year_rule_text": "Prvo document_date, zatim document_year, na kraju uploaded_at",
        "other_rule": "Pravilo za ostale dokumente",
        "other_rule_text": "Dokumenti tipa ostalo ukljucuju se samo ako su povezani s izvezenim transakcijama porezne godine.",
        "transactions_heading": "Godisnji pregled transakcija",
        "tx_count": "Broj transakcija",
        "income_total": "Ukupni prihodi",
        "expense_total": "Ukupni rashodi",
        "deductible_total": "Ukupno odbivo",
        "reconciled_count": "Broj uskladjenih",
        "pending_tx_count": "Transakcije na provjeri",
        "ignored_count": "Broj zanemarenih",
        "documents_heading": "Godisnji pregled dokumenata",
        "included_docs": "Ukljuceni dokumenti",
        "family_counts": "Broj po porodici",
        "excluded_docs": "Iskljuceni dokumenti",
        "risks_heading": "Rizici i podsjetnici",
        "pending_docs": "Dokumenti na provjeri u ovom paketu",
        "uncertain_year_docs": "Dokumenti dodijeljeni ovoj godini prema datumu ucitavanja",
        "skipped_files": "Datoteke iskljucene iz izvoza",
        "no_risks": "Nisu otkriveni otvoreni rizici za ovaj paket.",
        "all_parts_notice": "Cuvajte sve dijelove zajedno ako je paket podijeljen.",
        "usage_heading": "Kako koristiti ovaj paket",
        "usage_text": "Ovaj paket sadrzi sazetak PDF, godisnji CSV transakcija, godisnji PDF transakcija i porezne izvorne dokumente za odabranu poreznu godinu. Ostali izvjestajni PDF-ovi nisu ukljuceni i trebaju se zasebno preuzeti sa stranice izvjestaja. Godina dokumenta odredjuje se prema: document_date, zatim document_year, na kraju uploaded_at. Dokumenti tipa ostalo ukljucuju se samo ako su povezani s izvezenim transakcijama odabrane porezne godine.",
        "reason_year_mismatch": "Dokument dodijeljen drugoj poreznoj godini",
        "reason_foundation_opt_out": "Osnovni materijali nisu zatrazeni",
        "reason_other_unlinked": "Ostali dokument nije povezan s izvezenom transakcijom ove porezne godine",
        "reason_storage_missing": "Pohranjena datoteka nedostaje ili je necitljiva",
        "reason_unsupported": "Nepodrzani tip dokumenta za porezni paket",
        "reason_limit": "Paket premašuje ogranicenja izvoza",
    },
}
