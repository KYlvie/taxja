...
class OCREngine:
    ...
    _UNIFIED_VISION_EXTRACT_INSTRUCTIONS = (
        ...
        "For Versicherungsbestätigung: insurer_name, praemie (annual premium), polizze (policy number), "
        "versicherungsart (type of insurance), date, vertragsbeginn (contract start), "
        "zahlungsfrequenz (monthly/quarterly/annually), "
