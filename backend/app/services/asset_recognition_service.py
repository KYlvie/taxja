        ...
        try:
            ...
            response = llm.generate_simple(
                system_prompt=(
                    ...
                    "Treat materials consumed in production or resale (Wareneinsatz) as expense, regardless of amount. "
                    "The key distinction: assets are durable items used repeatedly over years; expenses are consumed, "
                    "transformed, or sold. Consider the buyer's business context when deciding. "
