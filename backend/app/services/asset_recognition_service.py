        ...
        try:
            ...
            response = llm.generate_simple(
                system_prompt=(
                    ...
                    "Treat raw materials, production materials, Wareneinsatz, inventory for production or resale as expense — "
                    "even if the total amount is high. Examples: wood (Holz, Eiche, Buche, Fichte), metal sheets, fabric, "
                    "construction materials (Beton, Ziegel, Fliesen), food ingredients, chemicals, packaging materials. "
                    "These are consumed in production, not durable equipment. "
