...
class TestAuditService:
    ...
    def test_log_property_create(self, db_session: Session, test_user):
    ...
    def test_log_property_update(self, db_session: Session, test_user):
    ...
    def test_log_property_delete(self, db_session: Session, test_user):
    ...
    def test_log_property_archive(self, db_session: Session, test_user):
    ...
    def test_log_transaction_link(self, db_session: Session, test_user):
    ...
    def test_log_transaction_unlink(self, db_session: Session, test_user):
    ...
    def test_log_depreciation_backfill(self, db_session: Session, test_user):
    ...
    def test_log_depreciation_generation(self, db_session: Session, test_user):
    ...
    def test_get_entity_audit_trail(self, db_session: Session, test_user):
    ...
    def test_get_user_audit_trail(self, db_session: Session, test_user):
    ...
    def test_get_user_audit_trail_filtered(self, db_session: Session, test_user):
    ...
    def test_get_recent_operations(self, db_session: Session, test_user):
    ...
    def test_get_recent_operations_filtered(self, db_session: Session, test_user):
    ...
    def test_audit_log_without_optional_fields(self, db_session: Session, test_user):
