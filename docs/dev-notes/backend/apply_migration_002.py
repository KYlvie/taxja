#!/usr/bin/env python
"""
Simple script to apply migration 002
...
def main():
    print("\n" + "="*70)
    print("APPLYING MIGRATION 002: add_property_table")
    print("="*70)
    ...
    try:
        ...
        print("\n" + "="*70)
        print("Next steps:")
        print("  1. Run tests: python test_migration_002.py")
        print("  2. Or run full test suite: python run_migration_test.py")
        print("="*70)
