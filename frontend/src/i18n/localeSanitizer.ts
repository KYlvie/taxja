...
const buildDocumentTypeShortHotfix = (typesShort: Record<string, string>): LocaleObject => ({
  documents: {
    typesShort,
  },
});
...
const DOCUMENT_TYPE_SHORT_HOTFIXES: Record<SupportedLanguage, LocaleObject> = {
  de: buildDocumentTypeShortHotfix({
    purchase_contract: 'Kaufvertrag',
    rental_contract: 'Mietvertrag',
    loan_contract: 'Kreditvertrag',
    bank_statement: 'Bankauszug',
    property_tax: 'Grundst.',
    svs_notice: 'SVS',
    einkommensteuerbescheid: 'Steuerbescheid',
    jahresabschluss: 'Abschluss',
    spendenbestaetigung: 'Spendenbest.',
    versicherungsbestaetigung: 'Versicherungsbest.',
    kinderbetreuungskosten: 'Kinderbetreuung',
    fortbildungskosten: 'Fortbildung',
    pendlerpauschale: 'Pendlerpausch.',
  ...
  en: buildDocumentTypeShortHotfix({
    purchase_contract: 'Purchase contract',
    rental_contract: 'Rental contract',
    loan_contract: 'Loan contract',
    bank_statement: 'Bank statement',
    property_tax: 'Property tax',
    svs_notice: 'SVS notice',
    einkommensteuerbescheid: 'Tax assessment',
    jahresabschluss: 'Annual accounts',
    spendenbestaetigung: 'Donation cert.',
    versicherungsbestaetigung: 'Insurance conf.',
    kinderbetreuungskosten: 'Childcare',
    fortbildungskosten: 'Training',
    pendlerpauschale: 'Commuter allow.',
    kirchenbeitrag: 'Church tax',
    grundbuchauszug: 'Land register',
    betriebskostenabrechnung: 'Service charge',
    gewerbeschein: 'Trade license',
    kontoauszug: 'Account stmt.',
  }),
  zh: buildDocumentTypeShortHotfix({
    purchase_contract: '购置合同',
    rental_contract: '租赁合同',
    loan_contract: '贷款合同',
    bank_statement: '银行流水',
    property_tax: '房产税',
    svs_notice: 'SVS通知',
    einkommensteuerbescheid: '所得税决定',
    jahresabschluss: '年度结算',
    spendenbestaetigung: '捐赠证明',
    versicherungsbestaetigung: '保险确认',
    kinderbetreuungskosten: '育儿费用',
    fortbildungskosten: '培训费用',
    pendlerpauschale: '通勤补贴',
    kirchenbeitrag: '教会税',
    grundbuchauszug: '土地登记',
    betriebskostenabrechnung: '物业费结算',
    gewerbeschein: '营业许可',
    kontoauszug: '账户对账单',
  }),
  fr: buildDocumentTypeShortHotfix({
    purchase_contract: 'Contrat achat',
    rental_contract: 'Contrat loc.',
    loan_contract: 'Contrat pret',
    bank_statement: 'Releve banc.',
    property_tax: 'Impot foncier',
    svs_notice: 'Avis SVS',
    einkommensteuerbescheid: 'Avis fiscal',
    jahresabschluss: 'Comptes annuels',
    spendenbestaetigung: 'Certif. don',
    versicherungsbestaetigung: 'Attest. assurance',
    kinderbetreuungskosten: 'Garde enf.',
    fortbildungskosten: 'Formation',
    pendlerpauschale: 'Indem. trajet',
    kirchenbeitrag: 'Taxe eglise',
    grundbuchauszug: 'Extrait foncier',
    betriebskostenabrechnung: 'Decompte charges',
    gewerbeschein: 'Licence comm.',
    kontoauszug: 'Releve compte',
  }),
  ru: buildDocumentTypeShortHotfix({
    purchase_contract: 'Dogovor pokupki',
    rental_contract: 'Dogovor arendy',
    loan_contract: 'Kreditnyy dogovor',
    bank_statement: 'Bankovskaya vypiska',
    property_tax: 'Nalog na imushch.',
    svs_notice: 'Uvedomlenie SVS',
    einkommensteuerbescheid: 'Nalogovoe reshenie',
    jahresabschluss: 'Godovaya otchetnost',
    spendenbestaetigung: 'Spravka o pozhertv.',
    versicherungsbestaetigung: 'Strakh. podtverzhd.',
    kinderbetreuungskosten: 'Detskiy ukh. rash.',
    fortbildungskosten: 'Obuchenie',
    pendlerpauschale: 'Nadbavka za proezd',
    kirchenbeitrag: 'Tserkovnyy vznos',
    grundbuchauszug: 'Vypiska iz reestra',
    betriebskostenabrechnung: 'Ekspluat. raskhody',
    gewerbeschein: 'Torg. litsenziya',
    kontoauszug: 'Vypiska po schetu',
  }),
  hu: buildDocumentTypeShortHotfix({
    purchase_contract: 'Adasveteli szerz.',
    rental_contract: 'Berleti szerz.',
    loan_contract: 'Hitelszerz.',
    bank_statement: 'Bankszamlakiv.',
    property_tax: 'Ingatlanado',
    svs_notice: 'SVS ertesito',
    einkommensteuerbescheid: 'Adohatarozat',
    jahresabschluss: 'Eves zaras',
    spendenbestaetigung: 'Adomany igaz.',
    versicherungsbestaetigung: 'Bizt. igazolas',
    kinderbetreuungskosten: 'Gyerekfelugy.',
    fortbildungskosten: 'Tovabbkepzes',
    pendlerpauschale: 'Ingazasi atalany',
    kirchenbeitrag: 'Egyhazi ado',
    grundbuchauszug: 'Tulajdoni lap',
    betriebskostenabrechnung: 'Uzemi koltseg',
    gewerbeschein: 'Mukodesi eng.',
    kontoauszug: 'Szamlakivonat',
  }),
  pl: buildDocumentTypeShortHotfix({
    purchase_contract: 'Umowa zakupu',
    rental_contract: 'Umowa najmu',
    loan_contract: 'Umowa kredytu',
    bank_statement: 'Wyciag bank.',
    property_tax: 'Podatek od nier.',
    svs_notice: 'Powiad. SVS',
    einkommensteuerbescheid: 'Decyzja podatk.',
    jahresabschluss: 'Roczne zamkniecie',
    spendenbestaetigung: 'Potw. darowizny',
    versicherungsbestaetigung: 'Potw. ubezp.',
    kinderbetreuungskosten: 'Opieka nad dz.',
    fortbildungskosten: 'Szkolenie',
    pendlerpauschale: 'Dodatek dojazd.',
    kirchenbeitrag: 'Podatek koscielny',
    grundbuchauszug: 'Odpis ksiegi',
    betriebskostenabrechnung: 'Rozl. kosztow',
    gewerbeschein: 'Licencja handl.',
    kontoauszug: 'Wyciag z konta',
  }),
  tr: buildDocumentTypeShortHotfix({
    purchase_contract: 'Satin alma sozl.',
    rental_contract: 'Kira sozl.',
    loan_contract: 'Kredi sozl.',
    bank_statement: 'Banka ekstresi',
    property_tax: 'Emlak vergisi',
    svs_notice: 'SVS bildirimi',
    einkommensteuerbescheid: 'Vergi karari',
    jahresabschluss: 'Yillik kapanis',
    spendenbestaetigung: 'Bagis belgesi',
    versicherungsbestaetigung: 'Sigorta onayi',
    kinderbetreuungskosten: 'Cocuk bakimi',
    fortbildungskosten: 'Egitim',
    pendlerpauschale: 'Yol odemesi',
    kirchenbeitrag: 'Kilise vergisi',
    grundbuchauszug: 'Tapu kaydi',
    betriebskostenabrechnung: 'Isletme gideri',
    gewerbeschein: 'Ticaret ruhsati',
    kontoauszug: 'Hesap ekstresi',
  }),
  bs: buildDocumentTypeShortHotfix({
    purchase_contract: 'Kupoprodajni ug.',
    rental_contract: 'Ugovor o najmu',
    loan_contract: 'Kreditni ugovor',
    bank_statement: 'Bankovni izvod',
    property_tax: 'Porez na imov.',
    svs_notice: 'SVS obavijest',
    einkommensteuerbescheid: 'Poresko rjesenje',
    jahresabschluss: 'Godisnji obracun',
    spendenbestaetigung: 'Potvrda donacije',
    versicherungsbestaetigung: 'Potvrda osig.',
    kinderbetreuungskosten: 'Briga o djeci',
    fortbildungskosten: 'Obuka',
    pendlerpauschale: 'Naknada za prevoz',
    kirchenbeitrag: 'Crkveni doprinos',
    grundbuchauszug: 'Zemljisni izvod',
    betriebskostenabrechnung: 'Obracun trosk.',
    gewerbeschein: 'Dozvola djelatn.',
    kontoauszug: 'Izvod racuna',
  }),
};
  ...
  repairLocaleValue(
    deepMerge(
      ...
      deepMerge(
        ...
        DOCUMENT_TYPE_SHORT_HOTFIXES[language]
      )
    )
