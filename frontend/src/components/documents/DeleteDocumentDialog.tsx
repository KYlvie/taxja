          ...
          <div className="cfd-robot-bubble cfd-robot-bubble--danger ddd-robot-bubble">
            ...
            {isTyping ? (
              ...
              <div className="ddd-content">
                <p className="ddd-lead">{introText}</p>
                  ...
                  <div className="ddd-related">
                    ...
                    {relatedData.related_data.linked_mietvertrag && (
                      <div className="ddd-related-item">
                        <strong>
                          {t(
                            'documents.deleteDialog.linkedMietvertrag',
                    ...
                    {relatedData.related_data.recurring_transactions &&
                      relatedData.related_data.recurring_transactions.length > 0 && (
                        <div className="ddd-related-item">
                          <strong>
                            {t(
                              'documents.deleteDialog.recurringTransactions',
                ...
                <div className="ddd-options">
                  ...
                  >
                    ...
                    />
                    <div>
                      <div className="ddd-option-title">
                        {t('documents.deleteDialog.documentOnly')}
                      </div>
                      <div className="ddd-option-desc">
                  ...
                  <label
                    className={`ddd-option ddd-option--danger ${
                ...
                {selectedMode === 'with_data' ? (
                  <div className="ddd-warn-box">{t('documents.deleteDialog.warning')}</div>
                ) : (
                  relatedData?.has_related_data && (
                    <div className="ddd-info-box">
            ...
            <div className={`cfd-robot-actions${showButtons ? ' cfd-robot-actions--visible' : ''}`}>
              ...
              <button
                ...
                style={
                  {
                    '--btn-color': selectedMode === 'with_data' ? '#dc2626' : '#7c3aed',
