...
const deShowcaseReports: ShowcaseReport[] = [
      { id: 'ea', icon: '📊', title: 'Einnahmen-Ausgaben-Rechnung 2025',
        headers: ['Datum', 'Beschreibung', 'Betrag', '✓'],
        rows: [['15.01', 'Gehalt Jänner', '€ 3.200,00', ''], ['10.03', 'Freelance Webdesign', '€ 1.800,00', ''], ['22.04', 'Mieteinnahmen Q1', '€ 2.700,00', ''], ['05.01', 'Homeoffice-Pauschale', '- € 300,00', '✓'], ['12.01', 'Laptop (Arbeitsmittel)', '- € 1.299,00', '✓'], ['01.04', 'Restaurant (privat)', '- € 45,00', '✗']],
        summary: [{ label: 'Einnahmen', value: '€ 17.300,00' }, { label: 'Ausgaben', value: '- € 3.069,90' }, { label: 'Ergebnis', value: '€ 14.230,10', accent: true }],
      },
      { id: 'e1', icon: '🏛️', title: 'E1 Einkommensteuererklärung 2025',
        headers: ['KZ', 'Feld', 'Betrag'],
        rows: [['245', 'Einkünfte nichtselbständig', '€ 45.000,00'], ['320', 'Einkünfte selbständig', '€ 28.650,00'], ['370', 'Einkünfte Vermietung', '€ 8.400,00'], ['717', 'Pendlerpauschale', '- € 1.356,00'], ['718', 'Homeoffice-Pauschale', '- € 300,00']],
        summary: [{ label: 'Gesamteinkünfte', value: '€ 82.050,00' }, { label: 'Steuerpfl. Einkommen', value: '€ 77.474,00', accent: true }],
      },
      { id: 'e1a', icon: '📝', title: 'E1a Beilage 2025',
        headers: ['KZ', 'Feld', 'Betrag'],
        rows: [['9040', 'Betriebseinnahmen', '€ 92.400,00'], ['9050', 'Wareneinsatz', '- € 12.300,00'], ['9060', 'Personalkosten', '- € 38.500,00'], ['9070', 'Abschreibung', '- € 4.200,00'], ['9080', 'Betriebsausgaben', '- € 8.750,00']],
        summary: [{ label: 'Gewinn/Verlust', value: '€ 28.650,00', accent: true }],
      },
      { id: 'e1b', icon: '🏠', title: 'E1b Vermietung 2025',
        headers: ['KZ', 'Feld', 'Betrag'],
        rows: [['400', 'Mieteinnahmen', '€ 14.400,00'], ['410', 'Betriebskosten-Anteil', '€ 2.160,00'], ['450', 'Gebäude-AfA (1,5 %)', '- € 3.000,00'], ['460', 'Instandhaltung', '- € 1.850,00'], ['470', 'Darlehenszinsen', '- € 2.400,00']],
        summary: [{ label: 'Mieteinnahmen (netto)', value: '€ 9.310,00', accent: true }],
      },
      { id: 'l1', icon: '👤', title: 'L1 Arbeitnehmerveranlagung 2025',
        headers: ['KZ', 'Feld', 'Betrag'],
        rows: [['210', 'Bruttobezüge (lt. L16)', '€ 45.000,00'], ['220', 'Sozialversicherung', '- € 8.145,00'], ['717', 'Pendlerpauschale', '- € 1.356,00'], ['718', 'Homeoffice-Pauschale', '- € 300,00']],
        summary: [{ label: 'Bemessungsgrundlage', value: '€ 34.659,00' }, { label: 'Gutschrift', value: '€ 1.247,00', accent: true }],
      },
      { id: 'u1', icon: '📅', title: 'U1 Jahres-USt-Erklärung 2025',
        headers: ['KZ', 'Position', 'Betrag'],
        rows: [['000', 'Gesamtumsatz', '€ 92.400,00'], ['029', 'Bemessungsgrundlage 20 %', '€ 92.400,00'], ['060', 'USt 20 %', '€ 18.480,00'], ['065', 'Vorsteuer', '- € 7.360,00']],
        summary: [{ label: 'Jahres-Zahllast', value: '€ 11.120,00', accent: true }],
      },
      { id: 'afa', icon: '🏗️', title: 'Anlageverzeichnis 2025',
        headers: ['Anlage', 'AK', 'AfA p.a.', 'Buchwert'],
        rows: [['MacBook Pro 16"', '€ 2.999,00', '€ 999,67', '€ 1.000,00'], ['Büromöbel', '€ 1.800,00', '€ 138,46', '€ 1.384,62'], ['Gebäude (Vermietung)', '€ 200.000,00', '€ 3.000,00', '€ 182.000,00']],
        summary: [{ label: 'Gesamt-AfA', value: '€ 9.713,13' }, { label: 'Gesamt-Buchwert', value: '€ 207.459,62', accent: true }],
      },
    ];

const zhShowcaseReports: ShowcaseReport[] = [
      { id: 'ea', icon: '📊', title: '收支报表 2025',
        headers: ['日期', '描述', '金额', '✓'],
        rows: [['15.01', '1月工资', '€ 3,200.00', ''], ['10.03', '自由职业 网页设计', '€ 1,800.00', ''], ['22.04', '租金收入 Q1', '€ 2,700.00', ''], ['05.01', '居家办公补贴', '- € 300.00', '✓'], ['12.01', '笔记本电脑（办公设备）', '- € 1,299.00', '✓'], ['01.04', '餐厅（私人）', '- € 45.00', '✗']],
        summary: [{ label: '收入', value: '€ 17,300.00' }, { label: '支出', value: '- € 3,069.90' }, { label: '净结果', value: '€ 14,230.10', accent: true }],
      },
      { id: 'e1', icon: '🏛️', title: 'E1 所得税申报 2025',
        headers: ['KZ', '字段', '金额'],
        rows: [['245', '受雇收入', '€ 45,000.00'], ['320', '经营收入', '€ 28,650.00'], ['370', '租赁收入', '€ 8,400.00'], ['717', '通勤补贴', '- € 1,356.00'], ['718', '居家办公补贴', '- € 300.00']],
        summary: [{ label: '总收入', value: '€ 82,050.00' }, { label: '应税收入', value: '€ 77,474.00', accent: true }],
      },
      { id: 'e1a', icon: '📝', title: 'E1a 附表 2025',
        headers: ['KZ', '字段', '金额'],
        rows: [['9040', '营业收入', '€ 92,400.00'], ['9050', '商品成本', '- € 12,300.00'], ['9060', '人工成本', '- € 38,500.00'], ['9070', '折旧', '- € 4,200.00'], ['9080', '经营费用', '- € 8,750.00']],
        summary: [{ label: '盈亏', value: '€ 28,650.00', accent: true }],
      },
      { id: 'e1b', icon: '🏠', title: 'E1b 租赁收入 2025',
        headers: ['KZ', '字段', '金额'],
      ...
      { id: 'l1', icon: '👤', title: 'L1 雇员税务申报 2025',
        headers: ['KZ', '字段', '金额'],
        rows: [['210', '工资总额（按 L16）', '€ 45,000.00'], ['220', '社会保险', '- € 8,145.00'], ['717', '通勤补贴', '- € 1,356.00'], ['718', '居家办公补贴', '- € 300.00']],
        summary: [{ label: '计税基础', value: '€ 34,659.00' }, { label: '退税', value: '€ 1,247.00', accent: true }],
      },
      { id: 'u1', icon: '📅', title: 'U1 年度增值税申报 2025',
        headers: ['KZ', '项目', '金额'],
        rows: [['000', '总营业额', '€ 92,400.00'], ['029', '计税基础 20%', '€ 92,400.00'], ['060', '增值税 20%', '€ 18,480.00'], ['065', '进项税', '- € 7,360.00']],
        summary: [{ label: '年度应缴增值税', value: '€ 11,120.00', accent: true }],
      },
      { id: 'afa', icon: '🏗️', title: '固定资产清单 2025',
        headers: ['资产', '成本', '年折旧', '账面价值'],
        rows: [['MacBook Pro 16"', '€ 2,999.00', '€ 999.67', '€ 1,000.00'], ['办公家具', '€ 1,800.00', '€ 138.46', '€ 1,384.62'], ['建筑（出租）', '€ 200,000.00', '€ 3,000.00', '€ 182,000.00']],
        summary: [{ label: '总折旧', value: '€ 9,713.13' }, { label: '总账面价值', value: '€ 207,459.62', accent: true }],
      },
    ];
...
const copy: Partial<Record<SupportedLanguage, Copy>> = {
  de: {
    ...
    showcaseReports: deShowcaseReports,
    ...
    faqs: [
      ...
      { q: 'Wie sicher sind meine Daten?', a: 'AES-256 Verschlüsselung, DSGVO-konform, alle Daten in der EU. Nur technisch notwendige Cookies (Login-Token) — kein Tracking, keine Werbung.' },
    ],
    ctaKicker: 'Bereit?',
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'How secure is my data?', a: 'AES-256 encryption, GDPR-compliant, all data stays in the EU. Only essential login cookies — no tracking or advertising.' },
    ],
    ctaKicker: 'Ready?',
  ...
  zh: {
    ...
    showcaseReports: zhShowcaseReports,
    featKicker: '核心功能',
    featTitle: '报税所需，一应俱全。',
    features: [
    ...
    faqs: [
      ...
      { q: '数据安全吗？', a: 'AES-256 加密，GDPR 合规，所有数据存储在欧盟。仅使用登录必需的 Cookie，不追踪、不投放广告。' },
    ],
    ctaKicker: '准备好了？',
    ctaTitle: '告别手动整理。',
  ...
  fr: {
    ...
    faqs: [
      ...
      { q: 'Mes donn\u00e9es sont-elles s\u00e9curis\u00e9es ?', a: 'Chiffrement AES-256, conformit\u00e9 RGPD, toutes les donn\u00e9es restent dans l\u2019UE. Seuls des cookies de connexion essentiels \u2014 aucun suivi ni publicit\u00e9.' },
    ],
    ctaKicker: 'Pr\u00eat ?',
  ...
  ru: {
    ...
    faqs: [
      ...
      { q: '\u041d\u0430\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0437\u0430\u0449\u0438\u0449\u0435\u043d\u044b \u043c\u043e\u0438 \u0434\u0430\u043d\u043d\u044b\u0435?', a: '\u0428\u0438\u0444\u0440\u043e\u0432\u0430\u043d\u0438\u0435 AES-256, \u0441\u043e\u043e\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0438\u0435 GDPR, \u0432\u0441\u0435 \u0434\u0430\u043d\u043d\u044b\u0435 \u0445\u0440\u0430\u043d\u044f\u0442\u0441\u044f \u0432 \u0415\u0421. \u0422\u043e\u043b\u044c\u043a\u043e \u043d\u0435\u043e\u0431\u0445\u043e\u0434\u0438\u043c\u044b\u0435 cookie \u0434\u043b\u044f \u0432\u0445\u043e\u0434\u0430 \u2014 \u043d\u0438\u043a\u0430\u043a\u043e\u0433\u043e \u043e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u043d\u0438\u044f \u0438 \u0440\u0435\u043a\u043b\u0430\u043c\u044b.' },
    ],
    ctaKicker: '\u0413\u043e\u0442\u043e\u0432\u044b?',
  ...
  hu: {
    ...
    faqs: [
      ...
      { q: 'Mennyire biztonságosak az adataim?', a: 'AES-256 titkosítás, GDPR-megfelelő, minden adat az EU-ban marad. Csak bejelentkezéshez szükséges cookie-k — nincs követés, nincs reklám.' },
    ],
  ...
  pl: {
    ...
    faqs: [
      ...
      { q: 'Jak bezpieczne są moje dane?', a: "Szyfrowanie AES-256, zgodność z RODO, wszystkie dane w UE. Tylko niezbędne ciasteczka logowania — bez śledzenia i reklam." },
    ],
    ctaKicker: 'Gotowy?',
  ...
  tr: {
    ...
    faqs: [
      ...
      { q: "Verilerim ne kadar güvende?", a: "AES-256 şifreleme, KVKK uyumlu, tüm veriler AB içinde. Yalnızca oturum açma çerezleri — takip veya reklam yok." },
    ],
  ...
  bs: {
    ...
    faqs: [
      ...
      { q: 'Koliko su sigurni moji podaci?', a: "AES-256 enkripcija, GDPR usklađenost, svi podaci u EU. Samo neophodni kolačići za prijavu — bez praćenja i reklama." },
    ],
    ctaKicker: 'Spremni?',
